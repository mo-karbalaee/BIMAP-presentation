...
% Additional packages
% ------------------------------------------------
% media9: embed the Cellpose segmentation video on slide 3.
% Playback works only in Adobe Acrobat/Reader; other viewers show the poster
% still. Load after hyperref.
\usepackage{media9}
