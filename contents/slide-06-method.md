...
Message of this slide: my approach is self-supervised learning, the same paradigm behind modern generative AI (LLMs). Specifically JEPA, which predicts in latent space rather than pixels. My contribution is adapting this to calcium-imaging segmentation so I can learn from abundant unlabeled video and cut the need for scarce labels.
